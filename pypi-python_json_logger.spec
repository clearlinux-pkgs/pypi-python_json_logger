...
Source0  : https://files.pythonhosted.org/packages/e3/c4/358cd13daa1d912ef795010897a483ab2f0b41c9ea1b35235a8b2f7d15a7/python_json_logger-3.2.1.tar.gz
...
%prep
%setup -q -n python_json_logger-3.2.1
cd %{_builddir}/python_json_logger-3.2.1
pushd ..
cp -a python_json_logger-3.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735098903
