...
Source0  : https://files.pythonhosted.org/packages/4d/f7/8fe192d2535567deecc12d8b8e6c71230adebb4b0db407d852fff8e0b0cf/python-json-logger-2.0.5.tar.gz
...
%prep
%setup -q -n python-json-logger-2.0.5
cd %{_builddir}/python-json-logger-2.0.5
pushd ..
cp -a python-json-logger-2.0.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676251818
