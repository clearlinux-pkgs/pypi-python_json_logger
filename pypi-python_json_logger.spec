...
Source0  : https://files.pythonhosted.org/packages/4f/da/95963cebfc578dabd323d7263958dfb68898617912bb09327dd30e9c8d13/python-json-logger-2.0.7.tar.gz
...
%prep
%setup -q -n python-json-logger-2.0.7
cd %{_builddir}/python-json-logger-2.0.7
pushd ..
cp -a python-json-logger-2.0.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699920118
